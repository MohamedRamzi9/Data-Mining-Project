...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{knn/original.png}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{knn/random_under_sampling.png}
            \caption{KNN avec données Random Under Sampling}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{knn/random_over_sampling.png}
        ...
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{knn/smote_over_sampling.png}
            \caption{KNN avec données SMOTE Over Sampling}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{knn/tomek_under_sampling.png}
            \caption{KNN avec données Tomek Under Sampling}
        \end{subfigure}

        \caption{Comparaison des performances du KNN avec différentes techniques de rééchantillonnage}
    \end{figure}
...
\hline
Sans PCA & 1 & uniform & Manhattan \\
Avec PCA & 1 & uniform & Manhattan \\
\hline
\end{tabular}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{knn/final_no_pca.png}
        \caption{KNN - Résultats finaux sans PCA}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{knn/final_with_pca.png}
        \caption{KNN - Résultats finaux avec PCA}
    \end{subfigure}

    \caption{Comparaison des performances finales du KNN avec et sans réduction de dimensionnalité (PCA)}
\end{figure}
