...
\begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{decision_tree/random_under_sampling.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{decision_tree/random_over_sampling.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{decision_tree/smote_over_sampling.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{decision_tree/tomek_under_sampling.png}
...
\hline
\textbf{Configuration} & \textbf{Criterion} & \textbf{Max Depth} & \textbf{Min Samples Split} & \textbf{Min Samples Leaf} & \textbf{Max Features} \\
\hline
Sans réduction de dimensionnalité & gini & 39 & 2 & 1 & None \\
Avec réduction de dimensionnalité & gini & 50 & 2 & 1 & log2 \\
\hline
\end{tabular}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{decision_tree/final_no_pca.png}
    \caption{Decision Tree - Final Results with no PCA}
    \includegraphics[width=1\textwidth]{decision_tree/final_with_pca.png}
    \caption{Decision Tree - Final Results with PCA}
\end{figure}
