...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{random_forest/random_under_sampling.png}
            \caption{Random Forest avec données Random Under Sampling}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{random_forest/random_over_sampling.png}
        ...
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{random_forest/smote_over_sampling.png}
            \caption{Random Forest avec données SMOTE Over Sampling}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{random_forest/tomek_under_sampling.png}
            \caption{Random Forest avec données Tomek Under Sampling}
        \end{subfigure}

        \caption{Comparaison des performances du Random Forest avec différentes techniques de rééchantillonnage}
    \end{figure}
...
\hline
Sans PCA & gini & 100 & log2 \\
Avec PCA & gini & 100 & log2 \\
\hline
\end{tabular}
...
\hline
Sans PCA & 0.9985 & 0.9969 & 1 & 0.9985 \\
Avec PCA & 0.9434 & 0.9108 & 0.9829 & 0.9455 \\
\hline
\end{tabular}
\caption{Comparaison des performances avec et sans réduction de dimensionnalité}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{random_forest/final_no_pca.png}
        \caption{Random Forest – Résultats finaux sans PCA}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{random_forest/final_with_pca.png}
        \caption{Random Forest – Résultats finaux avec PCA}
    \end{subfigure}

    \caption{Comparaison des performances finales du Random Forest avec et sans réduction de dimensionnalité (PCA)}
\end{figure}
